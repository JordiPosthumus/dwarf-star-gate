...
from vllm.entrypoints.openai.chat_completion.qwen_contract import (
    enforce_qwen_output_request,
...
class ChatCompletionRequest(OpenAIBaseModel):
    ...
    def to_beam_search_params(
        ...
        enforce_qwen_output_request(self, max_tokens)
    ...
    @model_validator(mode="before")
    @classmethod
    def validate_reviewed_qwen_contract(cls, data):
        return validate_qwen_request(data, cls.model_fields)
