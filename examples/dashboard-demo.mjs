...
const relocationDiagnostics={schema:1,gateway_reason:null,idle_destinations:['mac-ultra'],sources:[{source:'sparkA',request_id:'12345678-1234-4234-8234-123456789abc',affinity:'existing',waiting_seconds:84,reason:'offer_ready',destination:'mac-ultra',conflicting_worker:null,automatic_reason:'automatic_wait_threshold',genie_reason:'genie_offer_ready'}],truncated:false};
const relocation={schema:1,automatic:true,automatic_scope:'first_unaffined_or_affinity_wait_expired',automatic_affinity_rebalance_min_wait_ms:300000,completed:2,rejected:0,diagnostics:relocationDiagnostics,offers:[{schema:1,evidence_id:'d'.repeat(64),request_id:'12345678-1234-4234-8234-123456789abc',source:'sparkA',destination:'mac-ultra',waiting_seconds:84,affinity:'existing',cache_locality:'unknown',automatic:false}]};
const clientWatch={schema:1,mode:'advisory',fresh_after_seconds:45,pre_gateway_after_seconds:20,runs:[
