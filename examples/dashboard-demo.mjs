...
const relocation={schema:1,automatic:true,automatic_scope:'first_unaffined_or_affinity_wait_expired',automatic_affinity_rebalance_min_wait_ms:300000,completed:2,rejected:0,offers:[{schema:1,evidence_id:'d'.repeat(64),request_id:'12345678-1234-4234-8234-123456789abc',source:'sparkA',destination:'mac-ultra',waiting_seconds:84,affinity:'existing',cache_locality:'unknown',automatic:false}]};
const snapshot = { version:1,demo:true,time:now,started:now-900000,read_only:false,worker_management:true,gateway_at:now,gateway_error:null,telemetry_error:null,
  ...
  gateway:{model:'deepseek-v4-flash',context_length:262144,queue_timeout_ms:72000000000,total:3,healthy:3,available:3,active:2,queued:1,draining:false,workers,dataset,predictor,recovery,
    continuity:{patient_wait:true,queued_relocation:true,automatic_relocation:true,automatic_relocation_scope:'first_unaffined_or_affinity_wait_expired',automatic_affinity_rebalance_min_wait_ms:300000,relocation:{completed:2,rejected:0,offers:1}}},devices,events };
