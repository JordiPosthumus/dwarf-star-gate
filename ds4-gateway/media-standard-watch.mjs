 ...
 async tick(){
  ...
  try{
   ...
   for(const t of this.targets){
    ...
    if(action&&old.dispatched===fingerprint&&!old.pending&&phase==='setup_needed'){phase='needs_attention';reason='Genie ended its setup reply without an observed operation; inspect the standard conversation.';action=null;}
