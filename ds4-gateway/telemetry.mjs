...
export function safeGatewayEvent(raw) {
  ...
  if (['terminal','terminal_without_done','terminal_without_finish_reason','terminal_reason_unobserved','engine_error','clean_eof_no_terminal','partial_sse_event','observation_limited','encoded_unobserved'].includes(raw.stream_end)) e.stream_end = raw.stream_end;
