...
export async function enrollProactiveResume({session,ui,reviewer,taskMessage,gatewayBaseUrl,providers,expiresAt,attemptBudget,createReceipts,signal,start=true}={}){
  ...
  const prepared=session.prepareContinuationEnrollment({gatewayBaseUrl,enrollment:{scopeId,sessionId,expiresAt,attemptBudget}});
  let receipts,bridge;
