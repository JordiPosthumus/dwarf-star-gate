...
export const ATTRIBUTION_CLOCK_TOLERANCE_MS=5000, ATTRIBUTION_MAX_DISPATCH_LEAD_MS=10*60000;
const WINDOW_MS=15*60000, MAX_OPEN_SPAN_MS=7*24*3600000, SKEW_MS=ATTRIBUTION_CLOCK_TOLERANCE_MS, MAX_DISPATCH_LEAD_MS=ATTRIBUTION_MAX_DISPATCH_LEAD_MS, MAX_RECORDS=512, MAX_OVERLAP_CANDIDATES=64;
