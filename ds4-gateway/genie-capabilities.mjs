...
export const genieCapabilityKeys=['fleet_reviews','rebalance','research','inspection','server_changes','hourglass','media'];
...
export function genieCapabilities(saved,config,recovery) {
  return {...Object.fromEntries(genieCapabilityKeys.map(key=>[key,key==='media'?config.media_jobs?.execution_enabled===true:key==='rebalance'?config.genie_load_balancing!==false:true])),...validateGenieCapabilities(saved),recovery:recovery===true};
}
