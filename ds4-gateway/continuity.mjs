...
const relocationPolicyReasons=new Set([...relocationReasons,'automatic_ready','affinity_requires_exact_offer','genie_disabled','genie_wait_threshold','genie_offer_ready']);
