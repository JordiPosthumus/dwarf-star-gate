...
const paths = new Set(['/workers','/priority-status','/priority-settings','/priority-manual','/priority-rules','/priority-review-next','/priority-review-result', '/add-worker', '/remove-worker', '/drain-workers', '/resume-workers', '/maintenance-lock','/release-maintenance-lock','/maintenance-receipt','/set-ssh-fallbacks','/set-context-limit','/set-queue-timeout','/set-protection','/relocate-queued','/genie-relocate-queued','/recovery-policy','/recovery-handback-policy','/recover-worker','/genie-recover-worker','/recovery-canary','/recovery-recheck','/agents','/grant-agent','/revoke-agent','/release-agent-hold']);
