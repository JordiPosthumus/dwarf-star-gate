...
const paths = new Set(['/workers','/current-jobs', '/add-worker', '/edit-endpoint', '/check-endpoint', '/remove-worker', '/drain-workers', '/resume-workers', '/maintenance-lock','/release-maintenance-lock','/maintenance-receipt','/set-ssh-fallbacks','/set-context-limit','/set-queue-timeout','/set-protection','/relocate-queued','/genie-relocate-queued','/recovery-policy','/recovery-handback-policy','/recover-worker','/genie-recover-worker','/recovery-canary','/recovery-recheck','/agents','/grant-agent','/revoke-agent','/release-agent-hold']);
