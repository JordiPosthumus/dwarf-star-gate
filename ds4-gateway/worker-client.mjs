...
const paths = new Set(['/genie-media-repair','/genie-media-inputs','/genie-media-setup','/media-setup-complete','/media-host-eligibility','/spark-services','/media-jobs','/genie-media-start','/workers','/current-jobs','/set-job-priority','/set-worker-concurrency', '/add-worker', '/edit-endpoint', '/check-endpoint', '/remove-worker', '/drain-workers', '/resume-workers', '/maintenance-lock','/release-maintenance-lock','/maintenance-receipt','/set-ssh-fallbacks','/set-context-limit','/set-conversation-turns','/set-queue-timeout','/set-genie-thinking','/set-protection','/relocate-queued','/genie-relocate-queued','/genie-capability','/recovery-policy','/recovery-handback-policy','/recover-worker','/genie-recover-worker','/recovery-canary','/recovery-recheck','/agents','/grant-agent','/revoke-agent','/release-agent-hold','/direct-activity','/set-direct-reserve']);
