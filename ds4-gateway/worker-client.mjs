...
export function workerControl(socketPath, route, body, {channel}={}) {
  ...
  return new Promise((resolve, reject) => {
    ...
    const timer = setTimeout(() => req.destroy(new Error('Worker control timed out; check current registration before retrying')), ['/genie-media-improvement','/genie-media-qualify','/genie-media-promote'].includes(route)?360000:route==='/genie-media-audit'?90000:30000);
