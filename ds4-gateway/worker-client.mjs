...
export function workerControl(socketPath, route, body, {channel}={}) {
  ...
  return new Promise((resolve, reject) => {
    ...
    const timer = setTimeout(() => req.destroy(new Error('Worker control timed out; check current registration before retrying')), route==='/genie-media-improvement'?360000:route==='/genie-media-audit'?90000:30000);
