...
def register_power(config,emit):
    ...
    def run(name,args):
        ...
        try:
            ...
            elif name=='fleet_recipe_rollout':payload={'action':'recipe-rollout','profile':args['profile'],'rollout_id':args['rollout_id']}
