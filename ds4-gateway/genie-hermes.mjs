...
export function hermesProvider(config,{directory,review=false}) {
  ...
  return {
    get info(){return {identity:identityStatus(home),runtime_provenance:runtime,gateway_tracking:!review&&config.gateway_tracking===true,engine:'Hermes',model:config.model,mode:'provider',can_act:false,research_available:Boolean(config.research),inspection_available:Boolean(config.inspection),operations_available:!review&&Boolean(config.operations)};},
