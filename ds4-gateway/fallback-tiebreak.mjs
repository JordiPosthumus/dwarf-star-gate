// Read-only comparator for DSG's deterministic fallback. It never selects or
// mutates a worker. Every tied candidate must have fresh, deployed evidence or
// the comparison abstains.
...
export function compareFallbackTieBreak(nodes,selected,forecasts,{now=Date.now(),maxAgeMs=60000}={}) {
  ...
  const base={schema:1,mode:'shadow',policy:'validated_remaining_tiebreak',selected:selectedId,minimum_load:minimum,candidates:[],alternative:null};
